...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {w1}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {w1}]
set_property PACKAGE_PIN W6 [get_ports {w2}]                                     
        set_property IOSTANDARD LVCMOS33 [get_ports {w2}]
set_property PACKAGE_PIN U8 [get_ports {w3}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {w3}]
set_property PACKAGE_PIN V8 [get_ports {w4}]                                     
        set_property IOSTANDARD LVCMOS33 [get_ports {w4}]
set_property PACKAGE_PIN U5 [get_ports {w5}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {w5}]
set_property PACKAGE_PIN V5 [get_ports {w6}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {w6}]
set_property PACKAGE_PIN U7 [get_ports {w7}]                                       
...
set_property PACKAGE_PIN U4 [get_ports {y2}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {y2}]
set_property PACKAGE_PIN V4 [get_ports {y3}]                                        
